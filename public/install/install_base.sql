...
CREATE TABLE IF NOT EXISTS `#__chatlog` (
...
CREATE TABLE IF NOT EXISTS `#__chatmsg` (
...
CREATE TABLE IF NOT EXISTS `#__deliveryorder` (
  `order_id` int(11) NOT NULL COMMENT '订单ID',
...
CREATE TABLE IF NOT EXISTS `#__deliverypoint` (
...
(28, 'admin_logo', '', '后台登录中心Logo'),
(29, 'admin_backlogo', '', '后台管理中心Logo'),
