<?php /*a:3:{s:74:"E:\phpStudy\PHPTutorial\WWW\www.dsmall.com\app\admin\view\config\base.html";i:1596782981;s:76:"E:\phpStudy\PHPTutorial\WWW\www.dsmall.com\app\admin\view\public\header.html";i:1596442214;s:81:"E:\phpStudy\PHPTutorial\WWW\www.dsmall.com\app\admin\view\public\admin_items.html";i:1596442214;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
        ...
        <div class="ncap-form-default">
            ...
            <dl>
                ...
                <dd>
                    ...
                    <span class="type-file-show"><img class="show_image" src="<?php echo htmlentities(ADMIN_SITE_ROOT); ?>/images/preview.png">
                        <div class="type-file-preview"><img src="<?php echo htmlentities(UPLOAD_SITE_URL); ?>/admin/common/<?php echo htmlentities($list_config['admin_logo']); ?>?<?php echo htmlentities(TIMESTAMP); ?>"></div>
                    </span>
                    <?php endif; ?>
            ...
            <dl>
                ...
                <dd>
                    ...
                    <span class="type-file-show"><img class="show_image" src="<?php echo htmlentities(ADMIN_SITE_ROOT); ?>/images/preview.png">
                        <div class="type-file-preview"><img src="<?php echo htmlentities(UPLOAD_SITE_URL); ?>/admin/common/<?php echo htmlentities($list_config['admin_backlogo']); ?>?<?php echo htmlentities(TIMESTAMP); ?>"></div>
                    </span>
                    <?php endif; ?>
