<?php /*a:3:{s:74:"E:\phpStudy\PHPTutorial\WWW\www.dsmall.com\app\admin\view\login\index.html";i:1596782933;s:76:"E:\phpStudy\PHPTutorial\WWW\www.dsmall.com\app\admin\view\public\header.html";i:1596442214;s:76:"E:\phpStudy\PHPTutorial\WWW\www.dsmall.com\app\admin\view\public\footer.html";i:1596442214;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<div class="login">
    <div class="login_body">
        <div class="login_header">
            <img src="<?php echo htmlentities(UPLOAD_SITE_URL); ?>/admin/common/logo.png"/>
        </div>
        <div class="login_content">
            <form method="post" id="login_form">
                ...
                <div class="form-group">
                    ...
                    <img src="<?php echo url('Login/makecode'); ?>" style="width:30%;height:38px;" id="change_captcha"/>
                </div>
                <div class="form-group">
...
<script>
            ...
            success: function (res) {
                layer.msg(res.message, {time: 1500}, function () {
                    if (res.code == 10000) {
                        ...
                        $('#change_captcha').attr('src', '<?php echo url("Login/makecode"); ?>?' + (new Date().getTime()));
                    }
                });
            }
        });
    ...
    $('#change_captcha').click(function () {
        $(this).attr('src', '<?php echo url("Login/makecode"); ?>?' + (new Date().getTime()));
    });
</script>
